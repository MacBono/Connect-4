...
public:
	...
	//KAŻDA KOLUMNA TO ODDZIELNY VECTOR
	//PLANSZA TO VECTOR ZŁOŻONY Z VECTORÓW KOLUMN


	// MOŻE PO PROSTU ZROBIE CHECKA CHECKB ALE JESZCZE NIE WIEM, CZY WARTO UŻYWAĆ PREVMOVE?
	...
	bool checkWin() {
		...
		for (int j = 0; j < height; j++) {
			...
			for (int i = 0; i < width; i++) {//KAŻDA KOLUMNA TO WEKTOR W KTÓRYM SZUKAMY PATTERNU
